...
# spark.sql("""
# select deyear.emp_no as emp_no
#                 , deyear.dept_no as dept_no
#                 , d.dept_name as dept_name
#                 , deyear.to_date as to_date
#                 , deyear.from_date as from_date
#                 , DATEDIFF(case when max(to_date)='9999-01-01' 
# 					then current_timestamp() 
# 					else to_date
# 					end, min(from_date))/365 as dept_years 
# 			from dept_emp deyear
# 	        left join departments d on deyear.dept_no = d.dept_no 
# 			group by deyear.emp_no, d.dept_name, deyear.dept_no, deyear.to_date, deyear.from_date
# """).show()


# spark.sql("""
# select * 
#     , DATEDIFF(case when to_date='9999-01-01' 
# 					then current_timestamp() 
# 					else to_date
# 					end,
# 					from_date
...
#                 , DATEDIFF(case when max(de.to_date)='9999-01-01' 
# 					then current_timestamp() 
# 					else de.to_date
# 					end, min(de.from_date))/365 as dept_years 
# 			from dept_emp de
